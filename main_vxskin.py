...
# def open_page(tab_index):
    ...
    drivers.find_element(By.XPATH, "/html/body/div/div/div/div/form/div/input").send_keys(username)
    drivers.find_element(By.XPATH, "/html/body/div/div/div/div/form/button").click()
    sleep(1)
    drivers.find_element(By.XPATH, "//input[@placeholder='Type your password']").send_keys(password)
    drivers.find_element(By.XPATH, "/html/body/div/div/div/div/form/button").click()
...
if __name__ == "__main__":
    ...
    url = "https://83dcf23cc6cb4bde.playground.demo.vamstack.com"
    # scrape and crawl
